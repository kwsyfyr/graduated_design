...
# 使用keras构建模型
from keras.layers import Input, Dropout, Dense, Activation, LeakyReLU, Conv2D, Conv1D, MaxPooling2D
...
model = Sequential()
model.add(Conv2D(16, (2, 2), activation='relu', input_shape=(X_train.shape[1], X_train.shape[2], 1)))
...
plot_model(model, to_file='./model_SimpleCNN.png', show_shapes=True)
