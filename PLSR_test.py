...
# 使用 f_regression
fregre_sele = SelectKBest(f_regression, k = 600)
...
# 十折交叉验证，打印得分
test_mse_scores = cross_val_score(pls2, x_test, y_test, cv=10, scoring='neg_mean_squared_error')
test_mae_scores = cross_val_score(pls2, x_test, y_test, cv=10, scoring='neg_mean_absolute_error')
test_r2_scores = cross_val_score(pls2, x_test, y_test, cv=10, scoring='r2')
